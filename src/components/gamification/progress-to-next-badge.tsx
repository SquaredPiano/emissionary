...
import { AchievementData } from '@/lib/services/gamification';
...
export function ProgressToNextBadge({ 
  ...
  const achievementProgress = nextAchievement 
    ? (nextAchievement.progress / nextAchievement.requirement.value) 
    : 1;
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-3 bg-white/50 dark:bg-black/20 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  >
                    {nextAchievement.rarity} • +{nextAchievement.points} XP
                  </Badge>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span>Progress</span>
                  <span>{nextAchievement.progress} / {nextAchievement.requirement.value}</span>
                </div>
                ...
                <p className="text-xs text-muted-foreground text-center">
                  {nextAchievement.requirement.description}
                </p>
              </div>
            </div>
          </CardContent>
